    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a  href="admin-bookings.jsp">Bookings</a></li>
          <li><a class="nav-link scrollto active" href="admin-queries.jsp">Quries</a></li>
  ...
  <section id="hero" class="hero d-flex align-items-center section-bg">
    ...
    <div class="container">
      ...
      <div class="row justify-content-between gy-5">
        ...
        Vector<contactdata> v=s.logic_queriedetails(d);
        
          out.println("<table border=10>");
          
          for(contactdata d1:v)
          {
      		...
      		out.println("<td><label style=font:monospace;color:tomato;margin-left:70px;font-weight: bold;font-size: 30px  >"+d1.getSubject()+"</td>");
